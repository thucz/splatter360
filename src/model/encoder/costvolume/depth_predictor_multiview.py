...
# def log_depth_sampling(d_min, d_max, num_samples):
#     # 计算对数采样的深度值
#     log_depths = torch.logspace(torch.log2(torch.tensor(d_min)), torch.log2(torch.tensor(d_max)), num_samples, base=2)
...
# d_min = 0.1  # 最小深度值
# d_max = 10.0  # 最大深度值
# num_samples = 128  # 采样点数

# # 计算对数采样的深度值
# log_depths = log_depth_sampling(d_min, d_max, num_samples)
