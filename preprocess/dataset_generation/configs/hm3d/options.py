...
class ArgumentParser:
    ...
    def add_data_parameters(self):
        ...
        dataset_params.add_argument("--dataset", type=str, default="hm3d")
        ...
        dataset_params.add_argument(
            "--config",
            type=str,
            default="./dataset_generation/configs/hm3d.yaml",
        )
        dataset_params.add_argument(
        ...
        dataset_params.add_argument("--min_z", type=float, default=0.625)
